...
This module contains Utility powershell scripts for AzSolutionManager. You can load this utility into your current powershell session by running the following:
